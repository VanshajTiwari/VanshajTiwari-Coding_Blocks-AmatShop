...
import { deleteProducts, deleteUsers, fetchAllUsers, fetchProducts } from '../../redux/actions';
...
export default function ViewUser() {
  ...
  const rows = useSelector((state) => {return state.user});
      ...
      >
        <Box sx={deleteStyle}>
          ...
          <Stack spacing={2} direction="row">
            <Button variant="contained" onClick={() => deleteUserf()} >Confirm</Button>
